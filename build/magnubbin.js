...
(function() {
  var Main, Ookonsole, grid9IsActive, grid9OnlyShow, injectCSS, injectHTML, onMousedown, onMousemove, onMouseup, onPresetClick, onTouchend, onTouchmove, onTouchstart, rxyDelta, ryzDelta, scaleDelta, txyDelta, txzDelta, vpSize, ª, ªA, ªB, ªC, ªE, ªF, ªN, ªO, ªR, ªS, ªU, ªV, ªX, ªex, ªhas, ªredefine, ªtype, ªuid;
  ...
  Main = (function() {
    ...
    Main.prototype.initGrid9 = function() {
      var deltaFn, fn, fn1, fn2, id, main, meshDeltaFns, meshName, meshNames, sceneDeltaFns;
