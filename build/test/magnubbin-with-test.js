...
/*! Magnubbin 0.0.2 //// MIT Licence //// http://magnubbin.loop.coop/ */

(function() {
  var Main, Tudor, appendCSS, appendHTML, main, tudor, zz, ª, ªA, ªB, ªC, ªE, ªF, ªN, ªO, ªR, ªS, ªU, ªV, ªX, ªex, ªhas, ªredefine, ªtype, ªuid,
  ...
  Main = (function() {
    ...
    function Main(config) {
      ...
      this.xx = null;
      if (this.$cssTarget) {
        appendCSS(this.$cssTarget, "Appended by " + ªC + " " + ªV);
      }
      if (this.$htmlTarget) {
        appendHTML(this.$htmlTarget, "Appended by " + ªC + " " + ªV);
      }
    }
  ...
  appendCSS = function($cssTarget, title) {
  ...
  appendHTML = function($htmlTarget, title) {
  ...
  if ((ªA === ªtype(arts)) && (ªA === ªtype(resolvers)) && (ªA === ªtype(updaters))) {
    main = new Main({
      $cssTarget: $('style'),
      $htmlTarget: $('article')
    });
