...
/*! Magnubbin 0.0.22 //// MIT Licence //// http://magnubbin.loop.coop/ */
    ...
    Main.prototype.initGrid9 = function() {
      ...
      $('.magnubbin-view').addEventListener('mousedown', (function(_this) {
        return function(event) {
          var $control, $icon, $preexisting, color, displayProgram, displayUMatCameraLoc, h, hRatio, meshI, pickerProgram, pickerUMatCameraLoc, renderer, w, wRatio, wh, x, y;
          wh = vpSize();
          w = wh[0];
          h = wh[1];
