...
/*! Magnubbin 0.0.14 //// MIT Licence //// http://magnubbin.loop.coop/ */
...
(function() {
  ...
  Main = (function() {
    ...
    Main.prototype.initTasks = function() {
      ...
      return this.ookonsole.addTask('save', {
    ...
    Main.prototype.initGrid9 = function() {
      ...
      $('#grid9-scene-save').addEventListener('mousedown', (function(_this) {
        return function(event) {
          return _this.ookonsole.execute('save prompt prefix file:///Volumes/ldc/2015-Work/2015-Loop.Coop/Magnubbin/magnubbin/index.html?');
        };
      })(this));
